...
import 'package:notes_firebase/pages/recover_password_page.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Selector<RegistrationController, bool>(
                            selector:
                                (_, controller) => controller.isPasswordHidden,
                            builder:
                                (_, isPasswordHidden, __) => NoteFormField(
